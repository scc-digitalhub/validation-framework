...
# Filenames for outputs reports
FN_PROFILE_HTML = "profile_pandas_profiling.html"
FN_PROFILE_JSON = "profile_pandas_profiling.json"
...
class ProfilePluginPandasProfiling(Profiling):
    ...
    def render_object(self,
        ...
        return [RenderTuple(strio_html, FN_PROFILE_HTML),
                RenderTuple(strio_json, FN_PROFILE_JSON)]
